(function () {
  ...
  var SNAPSHOT_CACHE_SCHEMA_VERSION = 2;
  ...
  function enrichAmeriFluxSitesWithMetadata(sites, siteInfoLookup) {
  ...
  function enrichFluxnet2015SitesWithMetadata(sites, siteInfoLookup) {
    return (Array.isArray(sites) ? sites : []).map(function (site) {
      var siteId = normalizeSiteId(site && site.site_id);
      var siteInfo = siteId && siteInfoLookup ? siteInfoLookup[siteId] : null;
      var enriched = Object.assign({}, site);
  ...
  function buildAttributionText() {
    return "The FLUXNET data presented here were discovered using a metadata snapshot generated by the Q.E.D. Lab FLUXNET Data Explorer. Contact TF Keenan (trevorkeenan@berkeley.edu) with any questions or suggestions. We appreciate acknowledgement of the QED FLUXNET Data Explorer when convenient. Available data is updated as of: 2026-03-06.";
  }

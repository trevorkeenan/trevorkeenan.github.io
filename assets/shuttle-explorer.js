(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      ".shuttle-explorer__field input.shuttle-explorer__range-input{flex:1 1 auto;min-width:0;padding:0;border:0;border-radius:0;background:transparent;accent-color:#2f5374;}",

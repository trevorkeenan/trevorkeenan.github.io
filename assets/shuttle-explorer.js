(function () {
  ...
  function buildAttributionHtml(snapshotUpdatedDate) {
    return "The data presented here were discovered using a metadata snapshot generated by the Q.E.D. Lab FLUXNET Data Explorer. Contact TF Keenan (<a href=\"mailto:trevorkeenan@berkeley.edu\">trevorkeenan@berkeley.edu</a>) with any questions or suggestions. We appreciate acknowledgement of the QED FLUXNET Data Explorer when convenient. Available data is updated as of: " + escapeHtml(snapshotUpdatedDateDisplayText(snapshotUpdatedDate)) + ".";
  }

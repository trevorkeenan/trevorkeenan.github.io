(function () {
  ...
  function createLayout(root) {
    ...
    root.innerHTML = [
      ...
      "    <li>The bulk-download scripts may require jq if neither jq nor python3 is already installed. jq is a lightweight command-line JSON parser used by the script workflow.</li>",
      "  </ul>",
      "</aside>",
